...
class Passenger{
    ...
    public:
    Passenger(string name1, int age, GenderType gender, string birthPreference, bool withChildren) 
    : name(name1), age(age), gender(gender), birthPreference(birthPreference), withChildren(withChildren), child(nullptr) {}
